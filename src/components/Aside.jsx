...
export default function Aside({show, handleClose}) {
  ...
  return (
    <>
        <Offcanvas show={show} onHide={handleClose} responsive='md' backdrop='static' className='text-white bg-secondary h-100'>
            <Offcanvas.Header closeButton closeVariant='white'>
                <Offcanvas.Title>Actions</Offcanvas.Title>
            </Offcanvas.Header>

            <Offcanvas.Body className='p-0 flex-md-column '>
                ...
                <div className="bottom">
                    ...
                    <div className="actions-box bg-secondary-2 p-3 d-flex gap-3 mt-2">
